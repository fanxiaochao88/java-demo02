...
public class DishController {
    ...
    @ApiOperation("批量删除菜品")
    // 自动讲dis转化成List
    public Result delete(@ApiParam("要删除的菜品id集合") @RequestParam List<Long> ids) {
        log.info("批量删除菜品：{}", ids);
    ...
    public Result<DishVO> getById(@ApiParam("菜品id") @PathVariable Long id) {
